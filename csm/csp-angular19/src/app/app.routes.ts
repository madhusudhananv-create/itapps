...
export const routes: Routes = [
 ...
 // Business Continuity Management (BCM) Module Routes
  // BCM is a separate application located in src/microapps/BCM/
  // Parent layout with nested routes for BCP and SCP
  {
    path: 'bcm',
    canActivate: [authGuard],
    loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/bcm-layout.component')
    ...
    children: [
      ...
      {
        path: 'bcp',
        loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/bcp-page.component')
          .then(m => m.BcpPageComponent),
        title: 'Business Continuity Plan'
      },
      {
        path: 'bcp/bc-exercise',
        loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/bc-exercise-page.component')
      ...
      {
        path: 'scp',
        loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/scp-accounts.component')
          .then(m => m.ScpAccountsComponent),
        title: 'Service Continuity Plan - Accounts'
      },
      {
        path: 'scp/form',
        loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/scp-page.component')
          .then(m => m.ScpPageComponent),
        title: 'Service Continuity Plan - Form'
      },
      {
        path: 'scp/pm/review',
        loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/scp-pm-review.component')
          .then(m => m.ScpPmReviewComponent),
        title: 'SCP PM Review Dashboard'
      },
      {
        path: 'scp/csm/approval',
        loadComponent: () => import('../microapps/BCM/app/pages/bcp-exercise/scp-csm-approval.component')
