...
// Update the Total Avg CSAT Scores calculation logic
const oldCalculation = // Calculate Total Avg CSAT Scores: Avg(avg(rating column value for each perspective))
