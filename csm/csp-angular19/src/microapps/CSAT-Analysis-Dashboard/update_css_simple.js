...
// Replace the CSS counting section
const oldSection =       // Get CSS counts from the second sheet data, filtered by CSAT cycle start date
      let cssSentCount = 0;
...
const newSection =       // Get CSS counts from the second sheet data, filtered by CSAT cycle start date
      let cssSentCount = 0;
      let cssReceivedCount = 0;
...
console.log('Successfully updated CSS counting logic!');
