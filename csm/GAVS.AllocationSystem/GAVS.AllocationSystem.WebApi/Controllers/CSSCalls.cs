...
namespace GAVS.AllocationSystem.WebApi.Controllers
{
    ...
    public partial class AllSysController
    {
        ...
        private void SendCSSSurveyMail(CSS_BATCH_CUSTOMERS_EXTENDED cust, string SurveyLink, CSS_BATCHES batch, string CurrentPeriod, string PreviousPeriod)
        {
            ...
            ep.SendEmail
                (
                new EmailConfig { environment = enumEnvironment.Dev, smtpAccount = _email, smtpHost = "smtp.office365.com", smtpPassword = _password, smtpPortValue = "587", excludeSender = true },
