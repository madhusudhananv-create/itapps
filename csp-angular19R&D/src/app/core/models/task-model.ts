/**
 * Task Models
 * Contains all task-related data models
 */
...
export class TaskModel {
  ...
  empName!: string;
  ownerName!: string;
  isEmpSelVisible: boolean = false;
  isOwner: boolean = true;
  isNew: boolean = true;
  isAudit!: boolean;
  isMoredetailsShown: boolean = false;
  moreText: string = "More Details...";
  reschedulE_REQUESTER: string | null = null;
  reschedulE_DATE: Date | null = null;
  reschedulE_REASON: string = "";
  statuS_PREV: string = "";
  reschedulE_DATE_PREV: Date | null = null;
  reschedulE_REQUESTER_PREV: string | null = null;
