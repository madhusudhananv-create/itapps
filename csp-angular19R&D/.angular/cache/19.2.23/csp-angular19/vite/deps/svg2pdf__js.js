...
var p = function() {
  function t2(t3) {
    if (this.a = void 0, this.r = 0, this.g = 0, this.b = 0, this.simpleColors = {}, this.colorDefs = [], this.ok = false, t3) {
      for (var e2 in "#" == t3.charAt(0) && (t3 = t3.substr(1, 6)), t3 = (t3 = t3.replace(/ /g, "")).toLowerCase(), this.simpleColors = {
        aliceblue: "f0f8ff",
        antiquewhite: "faebd7",
        aqua: "00ffff",
        aquamarine: "7fffd4",
        ...
        yellow: "ffff00",
        yellowgreen: "9acd32"
      }, this.simpleColors) t3 == e2 && (t3 = this.simpleColors[e2]);
      this.colorDefs = [{
...
var g = function() {
  ...
  return t2.prototype.clone = function(e2) {
    var r, i, n, a;
    return void 0 === e2 && (e2 = {}), new t2(this.pdf, {
      ...
      viewport: null !== (r = e2.viewport) && void 0 !== r ? r : this.viewport,
      refsHandler: this.refsHandler,
      styleSheets: this.styleSheets,
      textMeasure: this.textMeasure,
      transform: null !== (i = e2.transform) && void 0 !== i ? i : this.transform,
      withinClipPath: null !== (n = e2.withinClipPath) && void 0 !== n ? n : this.withinClipPath,
      withinUse: null !== (a = e2.withinUse) && void 0 !== a ? a : this.withinUse
    });
  }, t2;
}();
var b = function() {
  ...
  return e2.prototype.getRendered = function(t2, e3, r) {
    ...
    return this.idMap[(0, import_cssesc.default)(e3, {
      isIdentifier: true
    })];
  ...
  return u(e2, t2), e2.prototype.apply = function(t3) {
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(u2) {
        return (e3 = this.element.getAttribute("id")) ? (r = this.getStops(t3.styleSheets), a = 0, s2 = false, r.forEach(function(t4) {
          ...
          opacity: a / r.length
        })), l2 = new M(this.pdfGradientType, this.getCoordinates(), r, o), t3.pdf.addShadingPattern(e3, l2), [2]) : [2];
      });
    });
    ...
    return this.children.forEach(function(i2) {
      if ("stop" === i2.element.tagName.toLowerCase()) {
        var n2 = N(i2.element, t3, "color"), s2 = G(N(i2.element, t3, "stop-color") || "", n2 ? {
          color: G(n2, null)
        } : {
          color: r.contextColor
        }), o = parseFloat(N(i2.element, t3, "stop-opacity") || "1");
        a.push({
          offset: e2.parseGradientOffset(i2.element.getAttribute("offset") || "0"),
    ...
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(a) {
        switch (a.label) {
          ...
          case 1:
            return a.sent(), this.gradient.element.hasAttribute("gradientUnits") && "objectboundingbox" !== this.gradient.element.getAttribute("gradientUnits").toLowerCase() ? r = e2.pdf.unitMatrix : (i = t3.getBoundingBox(e2), r = e2.pdf.Matrix(i[2], 0, 0, i[3], i[0], i[1])), n = Q(N(this.gradient.element, e2.styleSheets, "gradientTransform", "transform"), e2), [2, {
              key: this.key,
              matrix: e2.pdf.matrixMult(n, r)
            }];
        }
      });
    });
    ...
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(o) {
        switch (o.label) {
          ...
          case 1:
            return n < s2.length ? [4, s2[n].render(new g(t3.pdf, {
              attributeState: t3.attributeState,
              refsHandler: t3.refsHandler,
              styleSheets: t3.styleSheets,
              viewport: t3.viewport,
              svg2pdfParameters: t3.svg2pdfParameters,
              textMeasure: t3.textMeasure
            }))] : [3, 4];
          case 2:
            o.sent(), o.label = 3;
          case 3:
  ...
  return u(e2, t2), e2.prototype.renderCore = function(t3) {
    ...
    return f(this, void 0, void 0, function() {
      return c(this, function(r) {
        switch (r.label) {
          case 0:
            return [4, this.getMarkers(e3, t3).draw(t3.clone({
              transform: t3.pdf.unitMatrix
            }))];
          case 1:
            return r.sent(), [2];
        }
...
var Tt = function() {
  ...
  return t2.prototype.setX = function(t3) {
    ...
    for (var e2 = 0; e2 < this.texts.length; e2++) this.textMeasures.push({
      width: t3.textMeasure.measureTextWidth(this.texts[e2], this.contexts[e2].attributeState),
    ...
    for (i = 0; i < this.textNodes.length; i++) {
      n = this.textNodes[i], a = this.contexts[i], s2 = this.textMeasures[i] || {
        width: e2.textMeasure.measureTextWidth(this.texts[i], this.contexts[i].attributeState),
    ...
    for (i = 0; i < this.textNodes.length; i++) if (n = this.textNodes[i], a = this.contexts[i], "#text" === n.nodeName || "hidden" !== a.attributeState.visibility) {
      ...
      e2.pdf.text(this.texts[i], l2[i] - y2, u2[i], {
        baseline: V(v2),
        angle: e2.transform,
  ...
  return u(e2, t2), e2.prototype.processTSpans = function(t3, e3, r, i, n, a) {
    for (var s2 = r.pdf.getFontSize(), o = "preserve" === r.attributeState.xmlSpace || "pre" === r.attributeState.whiteSpace, l2 = true, u2 = false, h2 = 0; h2 < e3.childNodes.length; h2++) {
      ...
      if (f2.textContent) {
        ...
        if ("#text" === f2.nodeName) {
          ...
          if (null !== g2) {
            var b2 = W(g2, s2);
            n = new Tt(this, N(m2, r.styleSheets, "text-anchor") || r.attributeState.textAnchor, b2, 0), i.push({
              type: "y",
              chunk: n
            });
          }
          ...
          if (null !== y2) {
            var v2 = W(y2, s2);
            n = new Tt(this, N(m2, r.styleSheets, "text-anchor") || r.attributeState.textAnchor, 0, v2), i.push({
              type: "x",
              chunk: n
            });
          }
    ...
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(c2) {
        ...
        }(f2, t3.attributeState), d2 = Ct(this.element, p2, t3), e3 = t3.textMeasure.getTextOffset(d2, t3.attributeState), u2 > 0 && (m2 = t3.textMeasure.measureTextWidth(d2, t3.attributeState), !("preserve" === t3.attributeState.xmlSpace || "pre" === t3.attributeState.whiteSpace) && f2.match(/^\s/) && (i = 0), r = (u2 - m2) / (d2.length - i) || 0), "visible" === h2 && (g2 = t3.attributeState.alignmentBaseline, b2 = St(t3.attributeState), t3.pdf.text(d2, a + o - e3, s2 + l2, {
          baseline: V(g2),
          angle: t3.transform,
          renderingMode: "fill" === b2 ? void 0 : b2,
          charSpace: 0 === r ? void 0 : r
        }), this.boundingBox = [a + o - e3, s2 + l2 + 0.1 * n, t3.textMeasure.measureTextWidth(d2, t3.attributeState), n]);
        else {
          for (y2 = [], v2 = new Tt(this, t3.attributeState.textAnchor, a + o, s2 + l2), y2.push({
            type: "",
            chunk: v2
          }), x2 = this.processTSpans(this, this.element, t3, y2, v2, {
            prevText: " ",
            prevContext: t3
          }), i = x2 ? 0 : 1, S2 = true, w2 = y2.length - 1; w2 >= 0; w2--) S2 && (S2 = y2[w2].chunk.rightTrimText());
      ...
      return c(this, function(l2) {
        switch (l2.label) {
          case 0:
            ...
            })), s2 = 0, o = this.children, l2.label = 1;
          case 1:
  ...
  return u(e2, t2), e2.prototype.isVisible = function(t3, e3) {
    ...
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(o) {
        switch (o.label) {
          case 0:
            return this.isVisible("hidden" !== e3.attributeState.visibility, e3) ? (r = this.getX(e3), i = this.getY(e3), n = this.getWidth(e3), a = this.getHeight(e3), e3.pdf.saveGraphicsState(), s2 = e3.transform, this.element.hasAttribute("transform") && (s2 = e3.pdf.matrixMult(Q(this.element.getAttribute("transform"), e3), s2)), e3.pdf.setCurrentTransformationMatrix(s2), e3.withinUse || "visible" === N(this.element, e3.styleSheets, "overflow") || e3.pdf.rect(r, i, n, a).clip().discardPath(), [4, t2.prototype.render.call(this, e3.clone({
              transform: e3.pdf.unitMatrix,
              viewport: e3.withinUse ? e3.viewport : new gt(n, a)
            }))]) : [2];
          case 1:
    ...
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(s2) {
        switch (s2.label) {
          ...
          case 1:
            return s2.sent(), (r = N(this.element, e3.styleSheets, "href")) && (i = this.getBoundingBox(e3), n = e3.pdf.internal.scaleFactor, a = e3.pdf.internal.pageSize.getHeight(), e3.pdf.link(n * (i[0] * e3.transform.sx + e3.transform.tx), a - n * (i[1] * e3.transform.sy + e3.transform.ty), n * i[2], n * i[3], {
              url: r
            })), [2];
        }
      });
    ...
    return f(this, void 0, void 0, function() {
      ...
      return c(this, function(s2) {
        switch (s2.label) {
          ...
          case 1:
            return r < i.length ? [4, i[r].render(new g(t3.pdf, {
              refsHandler: t3.refsHandler,
              styleSheets: t3.styleSheets,
              viewport: t3.viewport,
              withinClipPath: true,
...
function Gt(e2, r) {
  ...
  if (null != r && i.element.hasAttribute("id")) {
    var a = (0, import_cssesc.default)(i.element.id, {
      isIdentifier: true
    });
    r[a] = r[a] || i;
  }
  ...
  return f(this, arguments, void 0, function(t3, e3, r) {
    ...
    return void 0 === r && (r = {}), c(this, function(c2) {
      switch (c2.label) {
        ...
        case 1:
          return c2.sent(), u2 = new gt(e3.internal.pageSize.getWidth(), e3.internal.pageSize.getHeight()), f2 = h(h({}, r), {
            element: t3
