...
var HighchartsChartService = class _HighchartsChartService {
  ...
  loadHighchartsWithModules(partialConfig) {
    return __async(this, null, function* () {
      ...
      yield Promise.allSettled([...this.globalModules?.() ?? [], ...partialConfig?.modules?.() ?? []]);
      return highcharts;
    });
  }
  load(partialConfig) {
...
var HighchartsChartDirective = class _HighchartsChartDirective {
  ...
  keepChartUpToDate() {
    effect(() => __async(this, null, function* () {
      ...
      this._chartInstance = yield this.chart();
  ...
  constructor() {
    ...
    this.chart = computed(() => __async(this, null, function* () {
      const highCharts = this.highchartsChartService.highcharts();
      const constructorType = this.constructorType();
      yield this.delay(this.relativeConfig?.timeout ?? this.timeout ?? 500);
...
var defaultInstanceFactoryFunction = () => import("./highcharts-E7XJOJOJ.js").then((m) => m.default);
