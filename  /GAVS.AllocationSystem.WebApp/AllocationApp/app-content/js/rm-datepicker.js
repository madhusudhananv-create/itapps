...
(function () {
    ...
    .directive("rmDatepicker", ['rmDatepickerConfig', '$compile', '$filter', '$document',
        ...
        var link = function (scope, element, attrs, ngModel) {
            ...
            var adjustPos = function (el) {
                ...
                var posTop = innerHeight - el.offsetTop - scrollX - el.clientHeight
                var posLeft = innerWidth - el.offsetWidth - scrollY - el.clientWidth
                
                if (posTop < 35)
                    posTop = 35;


                var pos = { top: posTop, left: posLeft };
