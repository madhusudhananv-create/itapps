namespace GAVS.AllocationSystem.WebApi
{
    ...
    public partial class TASK_RECURRENCE
    {
        ...
        public bool? DAILY_IS_FIRDAY { get; set; }
        ...
        public string BIANNAUL_FIRST_SELECTED_DAY { get; set; }
        public int? BIANNAUL_FIRST_SKIP_DAYS { get; set; }
        public string BIANNAUL_FIRST_SELECTED_MONTH { get; set; }
        public string BIANNAUL_SECOND_SELECTED_DAY { get; set; }
        public int? BIANNAUL_SECOND_SKIP_DAYS { get; set; }
        public string BIANNAUL_SECOND_SELECTED_MONTH { get; set; }
