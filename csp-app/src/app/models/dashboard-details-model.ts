...
export class AllPortfolioDetails {
...
export class SuccessGoalsScoresModel {
    cusT_ID: string;
    cusT_NM: string;
    proJ_ID: string;
    proJ_NM: string;
...
export class SuccessGoalsScoresModelForAProject {
    cusT_ID: string;
    cusT_NM: string;
    proJ_ID: string;
    proJ_NM: string;
...
export class CSMDashboardDetailsModel {
    cusT_ID: string;
    cusT_NM: string;
    proJ_ID: string;
    proJ_NM: string;
...
export class TasksEventsSummary
{
    priority: string;
    dueEvents: number;
...
export class TasksEventsDetails
{
    ID : number;
    customerID  : string;
    customerName : string;
