...
@Component({
  selector: 'app-checklist-findings',
  templateUrl: './checklist-findings.component.html',
  styleUrls: ['./checklist-findings.component.scss']
})
export class ChecklistFindingsComponent implements OnInit {
  ...
  constructor(private _appService: AppsService, @Inject(MAT_DIALOG_DATA) public data: any, private dialogRef: MatDialogRef<ChecklistFindingsComponent>, private _util: myUtility, private _http: HttpClient) {
