...
export class IssuesPageComponent implements OnInit {
  ...
  portfolio: string[] = [];
  displayedColumns = ['index', 'portfoliO_NM', 'proJ_NM', 'description', 'issuE_TYPE', 'severity', 'actioN_PLAN', 'assigneD_TO', 'identifieD_DATE', 'targeT_DATE', 'issuE_RESOLVED_DATE', 'status', 'info', 'edit', 'delete'];
  ...
  ngOnInit() {
    ...
    if (!this._util.IsPremier(this.selectedCust))
      this.displayedColumns = ['index', 'proJ_NM', 'description', 'issuE_TYPE', 'severity', 'actioN_PLAN', 'assigneD_TO', 'identifieD_DATE', 'targeT_DATE', 'issuE_RESOLVED_DATE', 'status', 'info', 'edit', 'delete'];
  }
