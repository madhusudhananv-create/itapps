...
@Component({
  selector: 'app-actionitems-viewdetails',
  templateUrl: './actionitems-viewdetails.component.html',
  styleUrls: ['./actionitems-viewdetails.component.scss']
})
export class ActionitemsViewdetailsComponent {
  progress: boolean;

  private _dataModel: DashboardSearchParams = new DashboardSearchParams();
  selectedProject: string;
  selectedPortfoliovalue: string;
  actionitemDetails: any[];
  ...
  @Input() showActionitemsViewdetails: boolean = false;
  ...
  onClose() {
    this.Reset();
    this.showActionitemsViewdetails = !this.showActionitemsViewdetails;
  }
  ngOnInit(): void {
    // this.LoadParams();
  ...
  getProjectsbyCust() {
    this.actionitemDetails = this._cooDashboardCommon.customerSuccessSurvey.csat;
    let filteredRecords = this.actionitemDetails;
    if (this.selectedCust != "All")
      filteredRecords = this.actionitemDetails.filter(x => x.customeR_NAME == this.selectedCust);
  ...
  getcustomerSuccessSurvey() {
    ...
    this._cooDashboardCommon.popupCusts = this._cooDashboardCommon.getUniqueItemsFromList(this.actionitemDetails, "customeR_NAME");
    this._cooDashboardCommon.popupPortfolios = this._cooDashboardCommon.getUniqueItemsFromList(this.actionitemDetails, "portfoliO_NAME");
  ...
  getCustomerScorebyCustId(value) {
    let temp: any[] = this.actionitemDetails;
  ...
  Apply() {
    this.actionitemDetails = this._cooDashboardCommon.customerSuccessSurvey.csat;
    let dataView = this.actionitemDetails;
    //if (this.selectedCust != "All")
    ...
    this.actionitemDetails = dataView;
  }
