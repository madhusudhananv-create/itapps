...
export class KpiPageComponent implements OnInit {
  ...
  constructor(private _activatedRoute: ActivatedRoute, public _util: myUtility, private _appservice: AppsService, private _router: Router, changeDetectorRef: ChangeDetectorRef, media: MediaMatcher) {
