...
@Component({
  selector: 'app-crisp-scores-entry',
  templateUrl: './crisp-scores-entry.component.html',
  styleUrls: ['./crisp-scores-entry.component.scss']
})
export class CrispScoresEntryComponent implements OnInit {
